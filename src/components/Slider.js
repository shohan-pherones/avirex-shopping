  ...
  return (
    <div className="slider relative overflow-hidden">
      ...
      <div className="btns absolute left-0 right-0 bottom-20 m-auto w-fit flex gap-10 text-white mix-blend-color-dodge">
        <button
          className="btn-left border py-2 px-4 hover:bg-white hover:text-black duration-300"
          onClick={prevSlide}
        >
          <WestIcon />
        </button>
        <button
          className="btn-right border py-2 px-4 hover:bg-white hover:text-black duration-300"
          onClick={nextSlide}
        >
          <EastIcon />
        </button>
